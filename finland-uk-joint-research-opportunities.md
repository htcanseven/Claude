...
| **Cascade calls of the €93M wind project (D3-03 FSTP)** | first "breakthrough" call expected in the winning project's year 1 (~2027); €8M + later €16M "validation" calls | **up to €1M per third-party project, 12–18 months** | Sized exactly for a two-university team; themes will mirror the topic scope (O&M digitalisation, sensors, lifetime extension). Watch the winning consortium's website from early 2027. |
...
| **2ZERO: HORIZON-CL5-2027-03-D5-05** | opens 15 Dec 2026, **deadline 14 Apr 2027** | IA, ~€8M/project | Post-800V modular heavy-duty-vehicle powertrain — direct fit for LUT's fault-tolerant multiphase drives + direct liquid cooling, with Durham monitoring angle; diversifies you beyond wind. |
...
Jan–Apr   | 15 Apr: MSCA SE 2027 submission
          | 14 Apr: 2ZERO HDV powertrain topic (if pursuing the transport line)
