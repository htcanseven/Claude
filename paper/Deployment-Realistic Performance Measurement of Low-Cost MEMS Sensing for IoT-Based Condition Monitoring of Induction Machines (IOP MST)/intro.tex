...
LoRaWAN nodes. Finally, it establishes an \emph{uncertainty-aware reference
baseline} for low-cost IoT-based induction-machine condition monitoring, with the
feature set, evaluation protocols, estimator settings, and random seeds reported
in full, so that the baseline can be reimplemented independently.
