...
LoRaWAN nodes. Finally, it establishes a \emph{reproducible and uncertainty-aware
baseline} for low-cost IoT-based induction-machine condition monitoring, specified
in sufficient detail---features, evaluation protocols, classifier settings, and
random seeds---for independent reimplementation.
