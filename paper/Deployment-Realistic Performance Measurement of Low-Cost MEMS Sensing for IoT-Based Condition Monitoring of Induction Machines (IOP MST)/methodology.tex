...
All experiments used the fixed seeds $0$--$4$, and the feature set
(Table~\ref{tab:features}), estimator settings (Table~\ref{tab:impl}), and
partitioning rules are reported in full, so that the results can be
