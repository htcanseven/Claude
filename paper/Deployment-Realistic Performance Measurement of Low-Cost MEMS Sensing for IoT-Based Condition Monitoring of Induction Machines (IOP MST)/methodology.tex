...
All experiments used fixed seeds, and the feature set, classifier settings, and
partitioning rules are specified in full, so that the reported results can be
