...
```bash
cd paper
latexmk -pdf main.tex        # the manuscript (pdflatex + bibtex, three passes)
latexmk -pdf esm.tex         # Online Resource 1 (supplementary tables and figures)
```
...
| Path | Content |
|---|---|
| `main.tex` | class options, title page, declarations |
| `esm.tex` | Online Resource 1: feature definitions, computation details, tables S1–S12, figures S1–S2 |
