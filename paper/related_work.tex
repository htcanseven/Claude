% ============================================================================
%  Section II — Related Work  (IEEE TIM, IEEEtran)
...
\subsection{Vibration-Based Condition Monitoring of Induction Motors}
Vibration analysis is a mature and widely adopted modality for detecting
mechanical and electrical faults in induction motors, including bearing defects,
...
resolve characteristic bearing defect frequencies (BPFO, BPFI, BSF) and their
harmonics through spectral and envelope analysis. This paradigm underpins the
...
critical machines and leave the many low-value motors in a plant unmonitored.
...
bandwidth as insufficient for bearing diagnosis~\cite{pedotti2020lowcost}.
...
windows, a protocol we scrutinise in Section~\ref{subsec:leakage}.
...
telemetry~\cite{jakobsen2024lowcost}. These studies establish the feasibility of
...
MEMS-based motor diagnosis, including the baseline accompanying the dataset used
...
demonstrate edge deployment yet assume industrial bandwidth. To our knowledge, no
prior study jointly (i) evaluates ultra-low-rate smartphone-MEMS motor diagnosis
...
IoT-based condition monitoring of induction motors with low-cost MEMS sensing.
...
Smartphone / mobile motor FD~\cite{naha2017mobile,ertargin2023deep,ertargin2025automated}
