...
Programın çalışıp çalışmadığını buradan anlayacaksın. Hafızaya güvenme — geçen hafta ne
kaldırdığını bilmiyorsan üzerine ne koyacağını da bilemezsin.

**Doldurma biçimi:** `60×8, 60×8, 60×7` → set sırasına göre `ağırlık × tekrar`.
Vücut ağırlığı hareketlerinde sadece tekrar: `8, 7, 6`.

**RIR hatırlatma:** Hafta 1 → 4-5 RIR · Hafta 2 → 3-4 RIR · Hafta 3 → 2-3 RIR ·
Hafta 4+ → 1-2 RIR · Hafta 7 → deload
...
| Egzersiz | Hedef | H1 | H2 | H3 | H4 | H5 | H6 | H7* | H8 | H9 | H10 | H11 | H12 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Deadlift (trap/konvansiyonel) | 3×5 | | | | | | | | | | | | |
...
`*` H7 = deload haftası (hacim yarıya, ağırlık %60)

---

## Haftalık Ölçüm — BİRİNCİL TAKİP

**Bel çevresi senin ana metriğin.** Sabah, aç karnına, göbek deliği hizasından, karnı içine
çekmeden ölç. Kilo sütununa haftanın **ortalamasını** yaz (3-4 sabah ölçümünün ortalaması),
tek bir günün değerini değil.

Başlangıç: **99 kg** · Bel hedefi: **< 95 cm** (boy ÷ 2)
...
**Hedef eğim:** Haftada ~0.4 kg. İki hafta üst üste hiç değişim yoksa kaloriyi 150-200 kcal
düşür. Ağırlıkların düşmeye başladıysa tersini yap — açık fazla demektir.

---

## Aylık Ölçümler

Bu ölçülerin **sabit kalması veya artması** kas koruduğunun kanıtı. Bel inerken bunlar
duruyorsa rekomposizyon çalışıyor demektir.

| Ölçüm | Başlangıç | 1. Ay | 2. Ay | 3. Ay |
|---|---|---|---|---|
| Kilo (kg) | 99 | | | |
| **Bel — göbek deliği (cm)** | | | | |
| Göğüs (cm) | | | | |
| Kalça (cm) | | | | |
| Kol — kasılı, sağ (cm) | | | | |
| Uyluk — orta nokta, sağ (cm) | | | | |
| Fotoğraf (ön/yan/arka) | ☐ | ☐ | ☐ | ☐ |

---

## Beslenme Takibi

Hedef: **2.500 kcal · 190 g protein · 250 g karbonhidrat · 80 g yağ**
