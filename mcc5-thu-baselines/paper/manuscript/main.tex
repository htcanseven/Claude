...
linear probe---not clearly above the 0.111 achieved by the strongest
input-independent constant predictor---and the constituent metrics are
reported against such prevalence references throughout, which expose
several partial-recovery scores as prevalence-driven; the probe's genuine
advantage is a joint operating point of higher micro-$F_1$ (0.631--0.686
versus a best-constant 0.556) at comparable or lower false-addition cost.
Compound-context deprivation is measurably harmful chiefly when the
operating condition is also unseen (recombination versus two-sided context
zero-shot: micro-$F_1$ interaction $+0.040$, 95\% CI $[0.009, 0.073]$), and
cross-partner transfer is strongly directional, including one statistically supported score-orientation
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{photo_a}}]{Evin \c{S}ahin Sad{\i}k}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{photo_b}}]{H\"useyin Tayyer Canseven}
