...
compound setting reverses the picture: our diagnostic experiments on this
dataset show that a shared feature space lets the dominant (mechanical)
signature suppress the electrical one---a winding short detectable from
currents alone on 39\% of windows falls to 0.2\% once vibration features
are concatenated. The mechanism-specific feature families used here are a
